                    ...
                    <div class="card-body">
                        <form action="{{ route('approvers.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input style="width:25%" type="date" class="form-control @error('approved_date') is-invalid @enderror" name="approved_date">
                            ...
                            <div class="form-group">
                                <label>Status</label>
                                <select class="form-control @error('isApproved') is-invalid @enderror" name="isApproved" style="width:75%">
                            ...
                            <div class="form-group">
                                <label>Level</label>
                                <select class="form-control @error('level') is-invalid @enderror" name="level" style="width:75%">
